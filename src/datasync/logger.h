...
//! A define to log like with qDebug, but using a logger. QTDATASYNC_LOG must be defined to a pointer of a logger
#define logDebug() qCDebug(QTDATASYNC_LOG->loggingCategory())
//! A define to log like with qInfo, but using a logger. QTDATASYNC_LOG must be defined to a pointer of a logger
#define logInfo() qCInfo(QTDATASYNC_LOG->loggingCategory())
//! A define to log like with qWarning, but using a logger. QTDATASYNC_LOG must be defined to a pointer of a logger
#define logWarning() qCWarning(QTDATASYNC_LOG->loggingCategory())
//! A define to log like with qCritical, but using a logger. QTDATASYNC_LOG must be defined to a pointer of a logger
#define logCritical() qCCritical(QTDATASYNC_LOG->loggingCategory())
//! A convenient define to log a fatal error, using QtDataSync::Logger::reportFatalError. QTDATASYNC_LOG must be defined to a pointer of a logger
